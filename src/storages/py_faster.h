#ifndef DGL_STORAGES_PY_FASTER_H_
#define DGL_STORAGES_PY_FASTER_H_
...
struct FasterContext {
  store_t* store = nullptr;

  /*! \brief Get the FasterML context singleton */
  static FasterContext* getInstance() {
    static FasterContext ctx;
    return &ctx;
  }
